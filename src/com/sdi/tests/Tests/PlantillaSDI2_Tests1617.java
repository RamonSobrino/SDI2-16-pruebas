...
public class PlantillaSDI2_Tests1617 {
	...
	public void run() {
		...
		driver.get("http://localhost:8280/sdi2-16");
	...
	public void prueba11() {
		WebElement registro = driver.findElement(By
	...
	public void prueba12() {
		WebElement registerLink = driver.findElement(By.id("form-principal:register"));
		registerLink.click();
		SeleniumUtils.EsperaCargaPagina(driver, "text", "Registrar nuevo usuario", 60);
		new PO_RegisterForm().rellenaEntrada(driver, "testuser", "test@example.org", "testus3r", "testus3r");
		
		SeleniumUtils.EsperaCargaPagina(driver, "text", "Registrado correctamente", 60);
	...
	public void prueba13() {
		...
		registerLink.click();
		SeleniumUtils.EsperaCargaPagina(driver, "text", "Registrar nuevo usuario", 60);
		new PO_RegisterForm().rellenaEntrada(driver, "user1", "test@example.org", "testus3r", "testus3r");
		
		SeleniumUtils.EsperaCargaPagina(driver, "text", "The login is already used", 60);
	...
	public void prueba14() {
		...
		registerLink.click();
		SeleniumUtils.EsperaCargaPagina(driver, "text", "Registrar nuevo usuario", 60);
		new PO_RegisterForm().rellenaEntrada(driver, "wrongemail", "example.org", "testus3r", "testus3r");
		
		SeleniumUtils.EsperaCargaPagina(driver, "text", "El email tiene que ser <nombre>@<dominio>", 60);
		SeleniumUtils.textoPresentePagina(driver, "El email tiene que ser <nombre>@<dominio>");
	}
	...
	public void prueba15() {
		...
		registerLink.click();
		SeleniumUtils.EsperaCargaPagina(driver, "text", "Registrar nuevo usuario", 60);
		new PO_RegisterForm().rellenaEntrada(driver, "wrongpass", "wrong@example.org", "con", "con");
		
		SeleniumUtils.EsperaCargaPagina(driver, "text", "La contraseña tiene que contener como minimo 8 caracteres y al menos una letra o un numero", 60);
		SeleniumUtils.textoPresentePagina(driver, "La contraseña tiene que contener como minimo 8 caracteres y al menos una letra o un numero");
	}
